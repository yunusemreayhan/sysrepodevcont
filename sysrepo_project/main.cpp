...
/* Ana Fonksiyon */
int main() {
    const char *initial_yang_path = "/root/src/sysrepo_examples/network-config.yang";
    const char *update_yang_path = "/root/src/sysrepo_examples/network-config@2026-01-01.yang";
    const char *search_dirs = "/root/src/sysrepo_examples";
